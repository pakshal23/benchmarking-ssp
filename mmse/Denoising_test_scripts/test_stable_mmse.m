%% Script to test the MMSE estimator for alpha-stable signals by comparing with a message-passing 
...
handles.Prior = 'alpha-stable';
handles.K = K;
handles.Dist_Param = [1, 0, 1, 0];
...
mp_params.Dist_Param = handles.Dist_Param(1);
